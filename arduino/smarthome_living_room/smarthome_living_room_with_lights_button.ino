#
include < RCSwitch.h > #include < EEPROM.h > #include < dht.h >
...
# define RECEIVER_PIN_INTER 1# define RECEIVER_POW 4

// to switch on the sender - toggle pow pin
# define SENDER_PIN 10# define SENDER_POW 6

// use with 3.3v
# define DHT_PIN 2

// stations id
# define ALL_STATIONS 1# define CUR_STATION_ID 3

// if the MC asks the state
# define STATUS_INFO 0# define TOGGLE 5
...
// uncomment define
#
define lights_button# define debug
